...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        int (shared by all stacks) or comma separated. (for flow-matching decoder)
        """,
    )
    ...
    parser.add_argument(
        ...
        comma separated. (for text encoder)
        """,
    )
    ...
    parser.add_argument(
        ...
        (shared by all stacks) or comma-separated list. (for text encoder)
        """,
    )
    ...
    parser.add_argument(
        ...
        default="192",
        help="""
        Embedding dimension in encoder stacks: a single int or comma-separated list. (for text encoder)
        """,
    )
...
def run(rank, world_size, args):
    ...
    assert (
        params.return_tokens and params.return_feature
    ), f"""
    Both params.return_tokens and params.return_feature should be True, got
    {params.return_tokens} and {params.return_feature}."""
    ...
    tokenizer = Tokenizer(type=params.token_type, token_file=params.token_file)
