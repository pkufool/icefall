...
class SpeakerSimilarity:
    ...
    def score(
        ...
        Returns:
        - float: The Speaker Similarity (SIM-o) score between the two directories of speech files.
        """
        ...
        scores = []
        for real_embd, eval_embd in zip(embds_real, embds_eval):
            scores.append(
...
if __name__ == "__main__":
    ...
    score = SIM.score(args.real_path, args.eval_path)
    logging.info(f"SIM-o score: {score:.2f}")
